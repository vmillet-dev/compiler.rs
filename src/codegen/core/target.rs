//! Target platform abstractions and implementations
//! 
//! This module defines the target platform abstraction and provides
//! implementations for different platforms (Windows, Linux, macOS).
...
pub fn create_target(platform: TargetPlatform) -> Box<dyn Target> {
    match platform {
        TargetPlatform::WindowsX64 => Box::new(crate::codegen::targets::WindowsX64Target),
        TargetPlatform::LinuxX64 => Box::new(crate::codegen::targets::LinuxX64Target),
        TargetPlatform::MacOSX64 => Box::new(crate::codegen::targets::MacOSX64Target),
    }
}
