...
//! 
//! This module implements the Target trait for macOS x64 platform
//! using the Apple x64 ABI calling convention.

use crate::codegen::core::{Target, TargetPlatform, CallingConvention, Register};
...
impl Target for MacOSX64Target {
    ...
    fn parameter_registers(&self) -> Vec<Register> {
        ...
        // Note: RDI, RSI would be more accurate but not in our Register enum
        vec![Register::Rax, Register::Rdx, Register::Rcx, Register::R8, Register::R9]
    }
